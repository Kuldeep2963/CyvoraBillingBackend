...
const customerRatesRoutes = require('./routes/customerRates');
...
// Middleware
app.use(cors({
  origin: process.env.BASE_API_URL.split(','), // Allow multiple origins if needed
...
app.use('/api/customer-rates', authMiddleware, customerRatesRoutes);
