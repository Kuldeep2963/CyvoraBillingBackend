  ...
  return (
    <Box minH="100vh" position="relative" overflow="hidden" bg="#000000">
      ...
      <Box
        ...
        width="600px" height="600px" borderRadius="full"
        bg="rgba(99,179,237,0.12)" filter="blur(100px)"
        animation={`${float} 15s ease-in-out infinite`}
        pointerEvents="none"
      />
      <Box
        position="absolute" bottom="-20%" left="-10%"
        width="700px" height="700px" borderRadius="full"
        bg="rgba(118,75,162,0.12)" filter="blur(120px)"
            ...
            <VStack spacing={6} align="stretch">
              ...
              <form onSubmit={handleSubmit} noValidate style={{ width: "100%" }}>
                <VStack spacing={4}>
                  ...
                  {/* Email */}
                  <FormControl isRequired isInvalid={touched.email && !!fieldErrors.email}>
                    <FormLabel color="gray.400" fontWeight="medium" fontSize="sm">
                      Email
                    </FormLabel>
                    ...
                    <InputGroup>
                      ...
                      <Input
                        ...
                        bg="rgba(0,0,0,0.5)"
                        border="1px solid"
                        borderColor={touched.email && fieldErrors.email ? "red.400" : "rgba(255,255,255,0.1)"}
                        color="white"
                    ...
                    <FormErrorMessage fontSize="xs">{fieldErrors.email}</FormErrorMessage>
                  </FormControl>

                  {/* Password */}
                  <FormControl isRequired isInvalid={touched.password && !!fieldErrors.password}>
                    <FormLabel color="gray.400" fontWeight="medium" fontSize="sm">
                      Password
                    </FormLabel>
                    <InputGroup>
                      ...
                      <Input
                        ...
                        bg="rgba(0,0,0,0.5)"
                        border="1px solid"
                        borderColor={touched.password && fieldErrors.password ? "red.400" : "rgba(255,255,255,0.1)"}
                        color="white"
                        _placeholder={{ color: "gray.600" }}
                        _hover={{ borderColor: "#63B3ED" }}
                        _focus={{
                    ...
                    <FormErrorMessage fontSize="xs">{fieldErrors.password}</FormErrorMessage>
                  </FormControl>
                  ...
                  <Button
                    ...
                    _hover={{
                      ...
                      boxShadow: "0 10px 30px -5px rgba(99,179,237,0.4)",
                    }}
                    _active={{ transform: "translateY(0)" }}
                    // FIX 14: _disabled style so the button looks disabled, not invisible
